                ...
                <div className="container h-100 justify-content-center">
                    <div className="d-flex h-100 text-center align-items-center">
                        <div className="mx-auto">
                            <h2 className="display-1 typewriter color-2">
                                <img
                                    src={icon}
                                    className={"img-fluid"}
                                    data-aos="fade-left"
                            ...
                            <p
                                className="lead mb-0 color-2 fw-bold mt-2"
                                data-aos="fade-up"
                                data-aos-delay="1000"
                                data-aos-duration="1500"
                            >
                            ...
                            >
                                Start chasing your&nbsp;
                                <strong className="color-6 fw-bold">
                                    DREAM
                                </strong>{" "}
                                job
                            </p>
            ...
            >
                <section className="section services-section bg-color-2 p-5">
                    <div className="container">
                        <div className="row">
                            <div
                                className="col-lg-6 align-items-center justify-content-center my-auto"
                                data-aos="fade-up"
                                data-aos-duration="1000"
                            >
                                <div className="section-title d-flex flex-column color-3 justify-content-center text-center mx-auto">
                                    <h2 className="border-0 display-1">
                                        Let's get stared !
                                    </h2>
                                    <p className="text-left fw-bold fs-4 color-6">
                                        To start using our platform , you should
                                        create an account !
                                        <br />
                                    </p>
                                    <button
                                        className="btn d-flex rounded-pill bg-color-3  shadow mt-5 color-2 mx-auto"
                                        style={{
                                            fontSize: "20px",
                                        }}
                            ...
                            <div
                                className="col-lg-6 justify-content-center my-auto text-center"
                                data-aos="fade-right"
                                data-aos-duration="1000"
                            >
                                <img
                ...
                <section
                    className="section services-section bg-color-2"
                    id="services"
                >
                    <div className="container">
                        <div
                            ...
                            <div className="col-lg-7">
                                <div className="section-title">
                                    ...
                                    <p className="text-left">
                                        Jobify is a plateform where you can find
                                        , as an emolyee , your dream job .And if
                                        you are a company , here you will find a
                                        bunch of talented employees , motivated
                                ...
                                <div className="feature-box-1">
                                    ...
                                    <div className="feature-content">
                                        ...
                                        <p>
                                            ...
                                            customers of all sizes, specializing
                                            in creating stylish, modern
                                            websites.
                                        </p>
                                    </div>
                                </div>
                ...
                >
                    ...
                    >
                        <div className="row">
                            ...
                            <div className="col-md-3 mb-md-0 mb-3">
                                <h5 className="text-uppercase color-1 fw-bold">
                                    Contact Us
                                </h5>
                    ...
                    <div className="footer-copyright color-2 text-center shadow-lg py-3 bg-color-6">
                        © 2022 Copyright:
