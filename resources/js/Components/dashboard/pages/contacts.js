...
const Contacts = (props) => {
    ...
    return (
        ...
        >
            <div
                id="main-content"
                className=" bg-transparent d-flex flex-row flex-wrap align-items-center justify-content-around"
            >
                <div
                    className="input-group  bg-white border-1 rounded-pill mb-2 p-2 shadow-sm"
